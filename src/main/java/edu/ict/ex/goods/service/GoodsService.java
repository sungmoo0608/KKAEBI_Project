...
public class GoodsService {
	...
	// 상품 진열 미진열
    public boolean updateStatus(int goods_code, int status) {
        System.out.println("상품 상태 변경 중... 상품 코드: " + goods_code + ", 상태: " + status);
        return goodsMapper.updateStatusTo(goods_code, status); // 상태 변경
    }
}
