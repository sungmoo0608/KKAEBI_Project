...
public class JwtTokenProvider {
    ...
    private byte[] secretKey = "wwkS1jqy3S16U3RsOf8pWEOD7DlZ57ZOXuOLlnNnuhSx9azvSij3I2TKtIfho4Qn0ofN3NB7KznQgsglbOVKZw==".getBytes();
    ...
    public String createToken(String userid) {
        ...
        return Jwts.builder()
                ...
                .signWith(Keys.hmacShaKeyFor(secretKey), SignatureAlgorithm.HS256) // 사용할 암호화 알고리즘과 signature에 들어갈 secret 값 세팅
                .compact();
    } 
