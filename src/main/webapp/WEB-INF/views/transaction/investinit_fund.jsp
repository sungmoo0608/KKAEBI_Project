...
<script>
        function calculateNumber() {
            ...
            let tr_number = 0; // 이자 변수 초기화
            tr_number = Math.ceil((parseFloat(investAmt) / parseFloat(curPrice)) * 1000);
...
<label for="tr_number">매수좌수 :</label>
<input type="text"  id="tr_number"   name="tr_number" readonly style="background-color: #ffffe0;"/>  좌<br/>
