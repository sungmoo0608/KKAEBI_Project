...
<label for="tr_number">환전외화 :</label>
<input type="text" name="tr_number"  value="${transaction.trforign_amt}"     readonly style="background-color: #ffffe0;"/> ${transaction.goods_name} <br/>
