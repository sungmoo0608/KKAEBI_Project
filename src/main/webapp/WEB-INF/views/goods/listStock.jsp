...
<body>
	<div class="container mt-5">
		...
		<div class="container1">
			<a class="btn btn-outline-primary btn-rounded btn-sm mx-1" href="${pageContext.request.contextPath}/goods/list">모든 상품</a> 
			<a class="btn btn-outline-primary btn-rounded btn-sm mx-1" href="${pageContext.request.contextPath}/goods/Depositlist">예금 상품</a> 
			<a class="btn btn-outline-primary btn-rounded btn-sm mx-1" href="${pageContext.request.contextPath}/goods/Fundlist">펀드 상품</a> 
			<a class="btn btn-outline-primary btn-rounded btn-sm mx-1" href="${pageContext.request.contextPath}/goods/Exchangelist">외환 상품</a> 
			<a class="btn btn-outline-primary btn-rounded btn-sm mx-1" href="${pageContext.request.contextPath}/goods/Stocklist">주식 상품</a>
		</div>
			...
			<tbody>
				...
				<c:forEach var="goods" items="${goodsList}">
					<tr>
						...
						<td>${goods.goods.provider_code}</td>
						<td>${goods.goods.invest_gubun}</td>
						<td>${goods.stockprice.stock_price}</td>
						<td>임의값</td>
