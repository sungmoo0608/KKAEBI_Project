...
<script type="text/javascript">
    function openGoodsDetailView(user_id,goods_gubun,goods_code) {
        // 새로운 창을 열어서 상세 페이지를 표시
        var url = "${pageContext.request.contextPath}/basketlist/basketlistdetail?goods_code=" + goods_code;
        window.open(url, '_blank', 'width=1200,height=720');
    }
</script>

<script type="text/javascript">
    function BasketlistDeleteandReview(user_id,goods_gubun,goods_code,seq_no) {
        // 새로운 창을 열어서 상세 페이지를 표시
